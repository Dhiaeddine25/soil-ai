...
type RefusalAnalysisCardProps = {
  message: string;
  tips: string[];
};

export function RefusalAnalysisCard({ message, tips }: RefusalAnalysisCardProps) {
  return (
    <AgricultureCard className="border-rose-200 bg-rose-50 text-rose-950">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="text-xs uppercase tracking-[0.2em] text-rose-600">Analyse impossible</div>
          <div className="mt-1 text-xl font-semibold">Cette image ne permet pas une estimation fiable du sol.</div>
        </div>
      </div>
